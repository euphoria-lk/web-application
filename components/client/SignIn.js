...
class SignIn extends Component {
    ...
    handleClick = (e) => {
        ...
        axios.post('http://34.121.143.209:5000/api/v1/client-service/login', JSON.stringify(body), {
            headers: {
            ...
            .then((res) => {
                ...
                if (res.data.message && res.status === 200) {
                    ...
                    localStorage.setItem("userEmail", res.data.user_profile.email);
                    localStorage.setItem("userObj", JSON.stringify(res.data.user_profile));
                    setTimeout(() => {
                        window.location.replace('/client/counsellors')
                    }, 2000);
                }
        ...
        return (
            ...
            <Container style={{backgroundcolor: 'white'}} component="main" maxWidth="xs">
                ...
                <div className={classes.paper}>
                    ...
                    <Avatar alt="logo" src={'/euphoria-v2-art.png'} style={{width: '150px'}}
                            className={classes.bigAvatar}/> <h2>Sign In | User</h2>
