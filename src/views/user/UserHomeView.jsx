...
import {Card,CardActionArea,CardHeader,CardContent,Avatar,Typography} from '@material-ui/core'
...
class UserHomeView extends Component {
    ...
    render() {
        ...
        >
            ...
            <CardHeader
                    avatar={
                <Avatar  style={{backgroundColor:'blue',width:"50px",height:"50px"}} aria-label="recipe" >
                   D
                </Avatar>
        }
                style={{height:'30%'}}
